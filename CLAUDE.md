...
at /home/cnmfs/bioeolica-dev2/specs/007-quality-compliance-94pct/plan.md
<!-- SPECKIT END -->

<!-- gitnexus:start -->
# GitNexus — Code Intelligence

This project is indexed by GitNexus as **bioeolica-dev** (7158 symbols, 11464 relationships, 179 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
